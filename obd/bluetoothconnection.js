// some inspiration from https://github.com/Marmelatze/avea_bulb for connection handling
// VEEPEAK adapter used for demo is - 

const Queue = require("promise-queue");
const winston = require("winston");

let SERVICE_ID = "fc3414b5e7eb075ac0f13b16dfafadf6";
let CHARACTERISTIC_ID = "fc3414b5e7eb075ac0f13b16dfafadf6";
...
class Obd {
    constructor(peripheral) {
        ...
        this.running = false;
        this.commandQueue = [];
        winston.info("new bulb found", {obd: this.id()});
